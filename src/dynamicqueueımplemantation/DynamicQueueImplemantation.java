...
package dynamicqueueımplemantation;


public class DynamicQueueImplemantation {
   ...
   private int capacity = 2;
    ...
    public DynamicQueueImplemantation(){
    ...
    public static void main(String[] args) {
        DynamicQueueImplemantation queue = new DynamicQueueImplemantation();
        queue.enqueue(4);
        queue.dequeue();
        queue.enqueue(56);
        queue.enqueue(2);
